...
{
  "bsGitBranch" : "main",
  "projectName" : "java-rest-service-azure",
  ...
  "apiSystem" : "profile-management-azure",
  "apiOwner" : "customer-relations-department-azure",
  "apiDescription" : "Manage customer profiles",
  "databaseName" : "customer-database",
  "liveUpdateIDESupport" : true,
  "bsGitRepository" : "github.com?owner=Mpluya&repo=java-rest-service-azure"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Condition (#exposeOpenAPIEndpoint) evaluated to true
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [DESCRIPTION_VAL->Manage customer prof...(truncated), OWNER_VAL->customer-relations-d...(truncated), SYSTEM_VAL->profile-management-a...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=Mpluya&repo=java-rest-service-azure'
